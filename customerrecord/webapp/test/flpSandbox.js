		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#compsocustomerrecord-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compsocustomerrecord-display": {
								"semanticObject": "compsocustomerrecord",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pso.customerrecord",
									"url": sap.ui.require.toUrl("com/pso/customerrecord")
								}
							}
						}
					}
